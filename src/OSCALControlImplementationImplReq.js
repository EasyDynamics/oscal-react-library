...
const useStyles = makeStyles((theme) => ({
	...
	OSCALImplChildLevel: props => (props.childLevel > 0 ?
		{
		'margin': '1em 1.5em 1em 1.5em',
		'background-color': '#fffcf0'
		} : ''
	),
	OSCALImplReqChildLevelTitle: props => (props.childLevel > 0 ?
		{
		'font-size': '1.1rem'
		} : ''
	),
...
export default function OSCALControlImplementationImplReq(props) {
	...
	const control = props.controls.find(control => control.id === props.implementedRequirement.['control-id']);
