	    ...
	    <div className={classes.paper}>
	    	<Card>
	    		...
	    		<Grid container spacing={2}>
		    		<Grid item xs={12} className={classes.OSCALSystemImplementationHeader}>
			        	<Typography>
			        		System Implementation
				        </Typography>
		        	</Grid>
		    		<Grid item xs={12} className={classes.OSCALSystemCharacteristicsInfo}>
			        	<Typography>
		        	...
		        	<Grid item xs={12}>
			            <TableContainer>
				            <Table aria-label="Components">
				              ...
				              <TableBody>
				                {Object.entries(props.systemImplementation.components).map(([key, component], index) => (
				                  <TableRow key={key}>
				                    ...
				                    <TableCell>{component.status && component.status.state}</TableCell>
				                    <TableCell>
					                    <TableContainer>
								            <Table size="small">
								              <TableBody>
								                {component.props && component.props.map((property) => (
