...
export const OSCALPrimaryTable = (props) => {
    return (
        <Table
            {...props}
            sx={{ borderSpacing: "0 0.5rem", borderCollapse: "separate" }}
        />
    )
}
...
export const OSCALSecondaryTableContainer = (props) => {
    return (
        <TableContainer
            {...props}
            className="SecondaryTableContainer RightScrollbar"
        />
    )
}
...
export const OSCALSecondaryTableCellContainer = (props) => {
    return (
        <div
            {...props}
            className="SecondaryTableCellContainer RightScrollbar"
        />
    )
}
...
export const OSCALTertiaryTableOuterContainer = (props) => {
    return (
        <TableContainer
            ...
            sx={{
                border: (theme) =>
                    `1px solid ${theme.palette.lightGrayBlue.main}`,
            }}
        />
    )
}
...
export const OSCALTertiaryTableHeadCell = (props) => {
    return <TableCell {...props} className="TertiaryTableCell" />
}

export const OSCALTertiaryTableCell = (props) => {
    return (
        <TableCell {...props} padding={"none"} className="TertiaryTableCell" />
    )
}
